...
-(void) sameQuestion {
    [[CCDirector sharedDirector] replaceScene:[CCTransitionFadeDown transitionWithDuration:1.0 scene:[Q3Layer scene]]];
}
...
-(id) init
{
	...
	if( (self=[super init])) {
        ...
        //Question1
        CCMenuItemFont *question1 = [CCMenuItemFont itemWithLabel:[CCLabelBMFont labelWithString:@"What word is the same\nbackwareds, upside\ndown, and side to side?" fntFile:@"title3lines.fnt"] target:self selector:@selector(nextQuestion)];
